...
**HuskHoard** is an automated, transparent data-tiering engine for Linux. It turns your expensive NVMe drives into a bottomless file system by silently archiving cold data to cheap hard drives (CMR or SMR), LTO Tapes, or cloud buckets—while keeping the files fully visible and accessible to your OS. More info at www.huskhoard.com
